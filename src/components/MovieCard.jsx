        ...
        >
            <div className="relative overflow-hidden rounded-lg">
                ...
                <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button className="w-full py-2 bg-gradient-to-r from-[#D6C7FF] to-[#AB8BFF] text-primary font-bold rounded-lg cursor-pointer">
                        View Details
                    </button>
                </div>
            </div>
            ...
            <div className="mt-4">
                <h3 className="group-hover:text-[#D6C7FF] transition-colors duration-300">{title}</h3>
                <div className="content mt-2">
                    ...
                    <span className="text-light-200 mx-1">•</span>
                    <p className="lang text-sm text-light-200 uppercase">{original_language}</p>
                    <span className="text-light-200 mx-1">•</span>
                    <p className="year text-sm text-light-200">
